...
@section('content')
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Создать новое задание</h1>
            ...
            <form action="{{ route('admin.tasks.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="5"
                              class="w-full border rounded-2xl px-4 py-3 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-all">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="flex gap-4 mt-4">
                    <button type="submit"
                            class="px-6 py-3 bg-black text-white rounded-2xl shadow hover:bg-gray-800 transition-all font-semibold">
                        Создать
                    </button>
